...
public class NacosUserDetailsServiceImpl implements UserDetailsService {
    ...
    /**
     * Update user password and clear derived password cache.
     *
    ...
    public void updateUserPassword(String username, String password) {
        ...
        if (cachedUser != null) {
            ...
            cachedUser.setDerivedPassword(null);
        }
    ...
    /**
     * Create user and warm local cache when enabled.
     *
    ...
    private void invalidateChangedUsers(Map<String, User> previous, Map<String, User> current) {
        ...
        for (Map.Entry<String, User> entry : previous.entrySet()) {
            ...
            if (latest != null) {
                latest.setDerivedPassword(null);
            }
        }
    }
